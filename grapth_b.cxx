...
void							grapth_a<T>::dfs(void)
{
	...
	std::cout<< "Result for DFS" << std::endl;
...
void							grapth_a<T>::Fleri(void)
{
	...
	std::cout<< "Result for Fler" << std::endl;
...
void							grapth_a<T>::find_cycle(int s)
{
	...
	if (s > grapth.size())
	{
		std::cout<< "ERROR VALUE S" << std::endl;
		exit(1);
	}
	...
	std::cout<< "Result for Euler s = " << s + 1 << std::endl;
	for (int j = 0; j < result.size(); ++j)
		std::cout << result[j] << " "; 
	std::cout << std::endl;
}
...
void							grapth_a<T>::Kosaraju(void)
{
	...
	for (int i = 0; i < grapth.size(); ++i)
		visit[i] = false;
	std::cout<< "Result for Kosaraju" << std::endl;
	while (!stack.empty())
	{
